...
class Device_Fields(DeviceName2 = "Switch",device_initial_text_file2 = "SwitchInitialText.txt",device_commands_file2 = "SwichCommands.txt" ):
    ...
    device_initial_text_file = device_initial_text_file2
    device_commands_file = r"SwichCommands.txt" 
...
class Switch:
    ...
    def mainLoop(self):
        ...
        d = Device_Fields(DeviceName = "Router",device_initial_text_file = "RouterInitialText.txt",device_commands_file = "RouterCommands.txt")
